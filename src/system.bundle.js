!(function () {
  ...
  const P =
    "undefined" != typeof $global
      ...
      ? getApp().GameGlobal
      : void 0;
  (void 0 !== P ? P.System : System).constructor.prototype.instantiate =
    function (e, t) {
    ...
    (w.set = function (e, t) {
      ...
      R && "Module" === t[R]
        ...
        : ((n = Object.assign(Object.create(null), t)),
          R && Object.defineProperty(n, R, { value: "Module" }));
  ...
  var C,
    L,
    A = Promise.resolve(),
    I = { imports: {}, scopes: {}, depcache: {}, integrity: {} },
    W = i;
  function T() {
  ...
  if (
    ...
    i && (T(), window.addEventListener("DOMContentLoaded", T)),
    i)
  ) {
